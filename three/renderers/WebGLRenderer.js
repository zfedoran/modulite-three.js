ml.module('three.renderers.WebGLRenderer')
.requires('three.Three',
          ...
          'three.core.Vector3',
          'three.core.Vector4',
          'three.extras.objects.ImmediateRenderObject',
          'three.extras.objects.LensFlare',
          'three.extras.renderers.plugins.LensFlarePlugin',
          'three.extras.renderers.plugins.ShadowMapPlugin',
          'three.extras.renderers.plugins.SpritePlugin',
          'three.lights.AmbientLight',
          'three.lights.DirectionalLight',
          'three.lights.HemisphereLight',
          'three.lights.PointLight',
          'three.lights.SpotLight',
          'three.materials.LineBasicMaterial',
          'three.materials.MeshBasicMaterial',
          'three.materials.MeshDepthMaterial',
          'three.materials.MeshFaceMaterial',
          'three.materials.MeshLambertMaterial',
          'three.materials.MeshNormalMaterial',
          'three.materials.MeshPhongMaterial',
          'three.materials.ParticleBasicMaterial',
          'three.materials.ShaderMaterial',
          'three.objects.Line',
          'three.objects.Mesh',
          'three.objects.ParticleSystem',
          'three.objects.Ribbon',
          'three.objects.SkinnedMesh',
          'three.objects.Sprite',
          'three.renderers.WebGLRenderTargetCube',
          'three.renderers.WebGLShaders',
          'three.scenes.Fog',
          'three.scenes.FogExp2',
          'three.textures.CompressedTexture',
          'three.textures.DataTexture')
.defines(function(){
